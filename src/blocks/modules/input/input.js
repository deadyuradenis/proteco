...
$('.jsForm').each(function(){
    ...
    thisForm.submit(function (e) {
		...
		let checkboxes = thisForm.find('.jsCheckbox.jsInputReq');
		let inputFiles = thisForm.find('.jsFileInput.jsInputReq');
...
let changeInfTrigger = $('.jsChangeInfTrigger');
let changeInfSubmit = $('.jsChangeInfSubmit');
let changeInfCancel = $('.jsChangeInfCancel');

changeInfTrigger.on('click', function(){
    let thisBlock = $(this).closest('.jsChangeInfBlock');
...
changeInfSubmit.on('click', function(e){
    ...
    let inputs = thisBlock.find('.jsInput.jsInputReq');
...
let ModalDataItems = $('.jsModalDataItem');
ModalDataItems.each(function(){
	let next = $(this).find('.jsModalDataNext');
	let prev =  $(this).find('.jsModalDataBack');
	let inputs = $(this).find('.jsInput.jsInputReq');

	next.on('click', function(e){

		let thisBlock = $(this).closest('.jsModalDataItem');
...
let jsModalMarkingItems = $('.jsModalMarkingItem');
jsModalMarkingItems.each(function(){
	let next = $(this).find('.jsModalMarkingNext');
	let prev =  $(this).find('.jsModalMarkingPrev');
	let inputs = $(this).find('.jsInput.jsInputReq');

	let autoNext =  $(this).find('.jsModalMarkingAutoNext');
	


	next.on('click', function(e){

		let thisBlock = $(this).closest('.jsModalMarkingItem');
